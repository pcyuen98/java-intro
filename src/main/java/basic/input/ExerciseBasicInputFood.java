 ...
 *       promoting single-responsibility and reducing complexity in the main method.</li>
 *
 *   <li><b>Maintainability:</b> The modular structure allows for easy updates. New food or drink
 *       items can be added or modified by updating only relevant methods without affecting the rest
 *       of the program.</li>
 *
 *   <li><b>Readability:</b> Code is easier to read and understand. Avoids deeply nested switch
 *       statements and groups logic in well-named, purpose-specific methods.</li>
 *
 *   <li><b>Error Handling:</b> Invalid user input is managed by returning sentinel values (e.g., -1),
 *       making it simple to validate and handle incorrect choices without cluttering business logic.</li>
 * </ul>
 */
