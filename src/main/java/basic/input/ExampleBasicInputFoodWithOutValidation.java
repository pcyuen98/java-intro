...
/*   <li><b>Separation:</b> Food and drink logic are separated into individual methods and class,
*       promoting single-responsibility and reducing complexity in the main method.</li>
*       
*       move this into MenuItem another class
*/

public class ExampleBasicInputFoodWithOutValidation {
	...
	static final MenuItem[] foodMenu = { new MenuItem("McDonald's", 10), new MenuItem("Nasi Lemak", 2),
			new MenuItem("Mee Kosong", 1) };

	static final MenuItem[] drinkMenu = { new MenuItem("Milo", 2), new MenuItem("Teh Tarik", 1.50),
